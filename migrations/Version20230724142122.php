 ...
 */
final class Version20230724142122 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project ADD CONSTRAINT FK_2FB3D0EE8C03F15C FOREIGN KEY (employee_id) REFERENCES employee (id)');
